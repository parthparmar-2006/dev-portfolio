      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto">
        ...
        {hackathons.map((hack, idx) => (
          ...
          >
            ...
            {/* Info Section */}
            <div className="md:w-1/2 w-full p-5 sm:p-10 flex flex-col justify-between">
              <div>
                <h3 className="text-2xl sm:text-3xl font-bold text-blue-700 mb-2">{hack.name}</h3>
                ...
                <p className="text-gray-700 mb-6 text-base sm:text-lg">{hack.description}</p>
              </div>
              {hack.link && (
                <a
                  href={hack.link}
                  ...
                  className="flex items-center gap-2 border border-blue-600 text-blue-600 px-6 py-2 rounded-full font-semibold hover:bg-blue-50 transition text-base sm:text-lg w-max"
                >
